...
select * from items where items.price>=80 order by price asc
 ...
 */
SELECT address.address,address.district ,phone FROM address 
...
*/
select film_id,title,rental_rate,description,length from film 
